...
Telnet.prototype.login = function (data) {
    var _self = this;
    if (data.toString().indexOf("sername:") > -1 || data.toString().indexOf("ogin:") > -1 ) {
        _self.write(_self._username + "\r\n");
    }
    else if ((data.toString().indexOf("assword:") > -1)) {
        if (_self._en) {
    ...
    else if ((data.toString().indexOf("#") > -1 ) && (data.toString().indexOf(">") > -1 )) {
